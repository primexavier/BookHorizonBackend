      ...
      <nav class="c-sidebar-nav">
        <ul class="c-nav">
          <li class="c-nav-item"><a class="c-nav-link" href="/"> Dashboard<span class="badge badge-info">NEW</span></a></li>
          ...
          <li class="c-nav-item c-nav-dropdown"><a class="c-nav-link c-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-nav-dropdown-items">
              <li class="c-nav-item"><a class="c-nav-link" href="/base/breadcrumb"> Breadcrumb</a></li>
